...
> Antes de sentarte a contestar las preguntas, **asegura el estado del servidor**. Con la grabación todavía en marcha, detén la VM y crea una **instantánea del disco del sistema** en Azure, llamada **`Fase 8 terminada`**.
>
